...
class user_registration(models.Model):
    ...
    confirm_salary = models.CharField(max_length=100, default='')
    confirm_salary_status = models.CharField(max_length=10, default='0')
    ...
    signature = models.FileField(upload_to = 'images/', null=True, blank=True)
